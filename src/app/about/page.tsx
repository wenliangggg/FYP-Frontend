  ...
  return (
    <section className="bg-white py-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 text-pink-600">About Kidly</h1>
        <p className="text-lg text-gray-700 mb-6">
          Kidly is a smart recommendation platform that helps parents and teachers discover the best books and videos for children.
        ...
        <div className="bg-pink-50 p-6 md:p-10 rounded-xl shadow text-left">
          ...
          <p className="text-gray-700 mb-4">
            ...
            With Kidly, families and educators can trust that every recommendation supports healthy development.
          </p>
