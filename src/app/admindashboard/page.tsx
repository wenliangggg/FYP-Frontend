            ...
            {userQuestions.length === 0 ? (
              ...
              <div className="space-y-4">
                {userQuestions.map(question => (
                  <div
                    key={question.id}
                    className={`p-4 border rounded ${question.answered ? 'bg-green-50 border-green-200' : 'bg-yellow-50 border-yellow-200'
                      }`}
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`px-2 py-1 text-xs rounded ${question.answered ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                          }`}>
